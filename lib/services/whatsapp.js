...
class WhatsAppService {
  ...
  async getMediaUrl(mediaId) {
    try {
      ...
      // For media operations, WhatsApp Business API returns a URL that we need to fetch separately
      // The media ID gets us a metadata response that contains the actual download URL
