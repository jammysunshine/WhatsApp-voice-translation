...
class WhatsAppService {
  ...
  async getMediaUrl(mediaId) {
    try {
      ...
      // For media operations, WhatsApp Business API uses a specific endpoint to retrieve media metadata
      // The endpoint format is {base_url}/media/{media_id} and not {base_url}/{phone_number_id}/{media_id}
