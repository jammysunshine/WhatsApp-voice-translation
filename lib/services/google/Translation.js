  ...
  constructor() {
    ...
    try {
      ...
      if (config.google.credentials) {
        ...
        console.log('Google Translation client initialized with default configuration');
      }
    } catch (error) {
      console.error('Failed to initialize Google Translation client:', error.message);
      throw error;
    }
  }
